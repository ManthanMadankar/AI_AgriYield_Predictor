...
try:
    MODEL_PATH = "best_model_compressed.joblib"
    SCALER_PATH = "scaler.joblib"
    LE_CROP_PATH = "le_crop.joblib"
    LE_STATE_PATH = "le_state.joblib"
    LE_SEASON_PATH = "le_season.joblib"
    CSV_PATH = "merged_crop_yield_dataset.csv"
